    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('user.students.index') }}">
                    <i class="fa fa-user fa-1x"></i> Data Siswa
                </a>
                <a class="collapse-item" href="{{ route('user.subjects.index') }}">
                    <i class="fas fa-book-reader fa-1x"></i> Data Mata Pelajaran
                </a>
                <a class="collapse-item" href="{{ route('user.school_years.index') }}">
                    <i class="fas fa-calendar fa-1x"></i> Data Tahun Ajar
                </a>
                <a class="collapse-item" href="{{ route('user.school_profiles.index') }}">
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('user.graduation_grades.index') }}"
                ...
                <a class="collapse-item" href="{{ route('user.ppdb_grades.index') }}"
                    style="display: flex; align-items: flex-start; gap: 8px; white-space: normal; word-wrap: break-word; overflow-wrap: break-word;">
