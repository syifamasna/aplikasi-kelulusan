...
<head>
    ...
    <title>Tambah Guru - Aplikasi Kelulusan</title>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form action="{{ route('admin.teachers.store') }}" method="POST" style="overflow-x: hidden;">
                                    @csrf
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="guru_status" id="guru_status" required>
                                                    <option value="" selected disabled>Pilih Status Guru</option>
