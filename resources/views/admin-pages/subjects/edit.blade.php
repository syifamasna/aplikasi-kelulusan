...
<head>
    ...
    <title>Edit Mata Pelajaran - Aplikasi Kelulusan</title>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{ route('admin.subjects.update', $subject->id) }}" method="POST" style="overflow-x: hidden;">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama" value="{{ old('nama', $subject->nama) }}" class="form-control" id="mapel" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <a href="{{ route('admin.subjects.index') }}" class="btn btn-warning">Kembali</a>
