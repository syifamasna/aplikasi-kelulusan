...
<body>
    <div class="container">
        <div class="header">
            <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('img/logo.png'))) }}" alt="Logo Sekolah" class="logo">
        ...
        <div class="signature">
            ...
            <div class="signature-content" style="position: relative; top: 110px;">
                <p>Mengetahui,</p>
                <p>Kepala Sekolah</p>
                <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('img/logo.png'))) }}" alt="stamp" class="stamp">
