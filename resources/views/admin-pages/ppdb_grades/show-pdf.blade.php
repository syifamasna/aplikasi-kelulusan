    ...
    <div class="container">
        <div class="header">
            <div style="text-align: center;">
                ...
                <p style="text-align: justify;">Yang bertanda tangan di bawah ini, Kepala SD Islam Terpadu Aliya, Kecamatan Bogor Barat, Kota Bogor, menerangkan bahwa :</p>
            </div>
        </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ fmod($nilai, 1) == 0 ? number_format($nilai, 0, ',', '.') : number_format($nilai, 2, ',', '.') }}</td>
                    @endforeach
                    <td class="text-center font-weight-bold">{{ number_format($jumlahNilai, 0, ',', '.') }}</td>
                    <td class="text-center font-weight-bold">{{ number_format($rataRata, 2, ',', '.') }}</td>
                </tr>
                @endforeach
                <tr>
                    <td colspan="7" class="text-center font-weight-bold">Total</td>
                    <td class="text-center font-weight-bold">{{ number_format($totalJumlahNilai, 0, ',', '.') }}</td>
                    <td class="text-center font-weight-bold">{{ number_format($totalJumlahNilai / 5, 2, ',', '.') }}</td>
                </tr>
            </tbody>
        </table>
        <p style="text-align: justify;">Daftar nilai rapor sekolah dasar tahun {{ date('Y') }} ini digunakan untuk pendaftaran ke SMP/MTS.</p>
