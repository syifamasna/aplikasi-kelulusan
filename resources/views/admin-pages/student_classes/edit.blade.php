                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <!-- Input Form -->
                                <form action="{{ route('admin.student_classes.update', $student_classes->id) }}" method="POST" style="overflow-x: hidden;">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <a href="{{ route('admin.student_classes.index') }}" class="btn btn-secondary">Kembali</a>
