...
class SchoolYearController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.school_years.index', compact('schoolYears', 'keyword'));
    }

    // Menampilkan form untuk menambah tahun ajar baru
    public function create()
    {
        return view('pages.school_years.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('school_years.index')->with('success', 'Tahun ajar berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.school_years.edit', compact('schoolYear'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('school_years.index')->with('success', 'Tahun ajar berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('school_years.index')->with('success', 'Tahun ajar berhasil dihapus.');
    }
}
