...
class StudentClassController extends Controller
{
    public function index()
    {
        ...
        return view('pages.student_classes.index', compact('student_classes')); // Mengirim data kelas ke view
    }

    public function show($id)
    {
        $student_classes = StudentClass::findOrFail($id);
        return view('pages.student_classes.show', compact('student_classes'));
    }
    ...
    {
        $student_classes = StudentClass::findOrFail($id);
        return view('pages.student_classes.edit', compact('student_classes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('student_classes.index')->with('success', 'Data siswa berhasil diperbarui');
    }
}
