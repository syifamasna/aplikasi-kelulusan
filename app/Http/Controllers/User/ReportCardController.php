...
class ReportCardController extends Controller
{
    ...
    public function show($studentId, $reportCardId)
    {
        ...
        // Kirim data ke view
        return view('user-pages.report_cards.show', compact('student', 'reportCard', 'subjects', 'schoolProfile'));
    }
    ...
    public function exportPdf($student_id, $reportCard_id)
    {
        ...
        // Ambil data kelas siswa berdasarkan class_id
        $studentClasses = StudentClass::where('id', $student->class_id)->first();

        // Logic untuk generate PDF
        $pdf = Pdf::loadView('user-pages.report_cards.show-pdf', compact('student', 'reportCard', 'schoolProfile', 'studentClasses'));
