...
class SubjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user.subjects.index'); // Mengarahkan ke halaman daftar mata pelajaran
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('user.subjects.index'); // Kembali ke halaman daftar mata pelajaran
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('user.subjects.index'); // Mengarahkan kembali ke halaman daftar mata pelajaran
    }
}
